...
**출처, [C++ IOstream (입출력) 라이브러리](https://modoocode.com/143)**
...
- **[std::ifstrean::open](https://cplusplus.com/reference/fstream/ifstream/open/)**, **[std::ofstream::open](https://cplusplus.com/reference/fstream/ofstream/open/)**
...
- **참고, [C++ Reference > string](https://modoocode.com/category/C++%20Reference/string),** 왠만한 string 멤버 함수들은 다 공부해볼 수 있다.
...
- 참고, [IBM, 메세지 로깅 함수](https://www.ibm.com/docs/ko/netcoolomnibus/8.1?topic=operators-message-logging-functions).

### Harl has to complain without using a forest of if/else if/else

- if/else문 자체를 못쓰게 한 것은 아닌데... if/else문을 사용하면서 함수 4개를 로깅하려면 중첩해서 사용하는 것이 불가피하다. 물론 어떻게 몸을 비틀면 가능할지도 모르지만, 마음 편하게 switch문을 사용하는 것이 좋을 것 같다.
...
- C의 함수 포인터가 기억날 것이다. 기억 안나면 [여기](https://espebaum.github.io/42cursus/ft-striteri.html).
